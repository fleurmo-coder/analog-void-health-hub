      ...
      <div className="container px-4 mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <a href="/" className="text-2xl font-light text-white flex items-center gap-2 nav-w-logo mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#approach" className="text-gray-300 hover:text-emerald-400 transition-colors">Our Approach</a>
              </li>
              <li>
                <a href="#focus" className="text-gray-300 hover:text-emerald-400 transition-colors">Focus Areas</a>
              </li>
              <li>
                <a href="#partners" className="text-gray-300 hover:text-emerald-400 transition-colors">Partnerships</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-300 hover:text-emerald-400 transition-colors">Cookie Policy</a>
              </li>
            </ul>
          </div>
        </div>
