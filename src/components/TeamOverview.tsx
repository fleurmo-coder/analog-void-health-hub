...
const TeamOverview = () => {
  const teamMembers = [
    ...
    { role: 'Investment Analyst', name: 'Pending', isAffiliate: false, image: '/lovable-uploads/adc37770-11ae-43e5-b01e-ea30f8759ab7.png' },
          ...
          <div className="glass-card p-8 rounded-lg border border-white/20">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-gray-300">7 dedicated <span className="text-blue-300">core members</span> and 2 <span className="text-emerald-400">affiliates</span></p>
              </div>
            </div>
